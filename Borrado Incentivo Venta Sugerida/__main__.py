...
def main():
    logger.info("Iniciando proceso de borrado - Archivos incentivos venta sugerida - SFTP DEV")

    # Ruta de trabajo
    root = os.path.join("root", "Data")
    # Archivos para borrar de IncentivoVentaSugerida
    files_ventasugerida = [
        "VentaSugerida-Ventas.csv",
        "VentaSugerida-ImportMetas.csv"
    ]

    try:
        for file in files_ventasugerida:
